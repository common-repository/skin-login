<div class="sn_skin_login_preview">
	...
	<div class="sn_skin_login_preview_page sn_skin_login_preview_page_login login">
		...
		<div id="login">
			...
			<form name="loginform" id="loginform" action="http://localhost:8888/wordpress/wp-login.php" method="post">
				<p>
	...
	<div class="sn_skin_login_preview_page sn_skin_login_preview_page_forgot login">
		...
		<div id="login">
			<h1><a href="http://wordpress.org/" title="Powered by WordPress">My Shop</a></h1>
			<p class="message">Please enter your username or email address. You will receive a link to create a new password via email.</p>
	
			<form name="lostpasswordform" id="lostpasswordform" action="http://localhost:8888/myshop/wp-login.php?action=lostpassword" method="post">
				<p>
			...
			<p id="nav">
				<a href="http://localhost:8888/myshop/wp-login.php">Log in</a>
				 | <a href="http://localhost:8888/myshop/wp-login.php?action=register">Register</a>
			</p>
		
			<p id="backtoblog"><a href="http://localhost:8888/myshop/" title="Are you lost?">&larr; Back to My Shop</a></p>
