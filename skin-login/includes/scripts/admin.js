...
/* Show Elements on preivew */
	function show_overlay_classes() {
		...
		note_position_top = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('#login').position().top + "px";
		...
		/* Login h1 */
		note_position_left = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('h1').position().left + "px";
		note_position_top = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('h1').position().top + "px";
		...
		/* Login h1 a */
		note_position_left = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('h1 a').position().left + "px";
		note_position_top = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('h1 a').position().top + "px";
		...
		/* Login Form */
		note_position_left = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('form').position().left + "px";
		note_position_top = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('form').position().top + "px";
		...
		/* p#nav */
		note_position_left = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('p#nav').position().left + "px";
		note_position_top = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('p#nav').position().top + "px";
		...
		/* p#backtoblog */
		note_position_left = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('p#backtoblog').position().left + "px";
		note_position_top = jQuery('.sn_skin_login_preview .sn_skin_login_preview_page').eq(preview_to_show).find('p#backtoblog').position().top + "px";
...
/* Change Preview */
	...
	function add_new_styles() {
		...
		styles_to_output = style_background_image+' '+style_background_colour+' '+style_logo+' '+style_text_colour+' '+style_link_colour+' '+style_theme_css+' '+style_custom_css;
	...
	jQuery('.field_sn_skin_login_logo input[type="text"], .field_sn_skin_login_background_image input[type="text"], .field_sn_skin_login_background_colour input[type="text"], .field_sn_skin_login_text_colour input[type="text"], .field_sn_skin_login_link_colour input[type="text"], .field_sn_skin_login_theme_css textarea, .field_sn_skin_login_custom_css textarea, .show-image img').bind("load change blur keyup onpaste focus", function() {
		change_preview();
	});
	...
	jQuery('.field_sn_skin_login_theme .sn_skin_login_themes li a').click(function() {
		...
		jQuery('.field_sn_skin_login_theme .sn_skin_login_themes li').removeClass('active');
