...
function sn_skin_login_get_field($args, $i) {
	...
	<?php /* ACTUAL FIELDS */  } else { ?>
			...
			<?php /* TEXT */ if($field_type == "text") { ?>
						...
						<input id="<?php echo $field_id; ?>" class="regular-text <?php 
						if($field_id == "rp_tools_options[rp_tools_fx_prev_url]") { echo 'fix_prev_url'; } 
						else if($field_id == "rp_tools_options[rp_tools_fx_new_url]") { 
							echo 'fix_new_url';
						} else { echo ''; } ?>" type="<?php echo $field_type; ?>" 
			...
			<?php /* SELECT THEME */ } else if($field_type == "select_theme") { ?>
						...
						foreach ( $field_choices as $option ) {
								$label = $option['label']; ?>
							<li<?php if($field_value == $option['value']) { ?> class="active"<?php } ?>><a href="<?php echo $sn_skin_login_directory; ?>/includes/themes/<?php echo $option['value']; ?>.css" id="<?php echo $option['value']; ?>"><img src="<?php echo $sn_skin_login_directory; ?>/includes/themes/<?php echo $option['value']; ?>.jpg" alt="" /></a></li>
						<?php } ?>
						</ul>
